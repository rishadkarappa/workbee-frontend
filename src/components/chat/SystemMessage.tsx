...
export function SystemMessage({
  ...
  if (payload.type === 'WORK_BID_OFFER' || payload.type === 'WORK_BID_COUNTER') {
    ...
    return (
      <div className="my-2 flex justify-center">
        <div className="bg-white border-2 border-amber-200 rounded-2xl shadow-sm p-4 max-w-sm w-full">
          <div className="flex items-center gap-2 mb-3">
          ...
          <div className="bg-amber-50 rounded-xl p-3 mb-3 flex items-center gap-1">
